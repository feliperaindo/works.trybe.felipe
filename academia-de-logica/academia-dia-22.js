...
let numeroEncontradoTwo = [];
let search = 12;

for (let i = 0; i < number.length; i += 1) {
if(search === number[i]){
numeroEncontradoTwo.push(number[i]);
} 
}
console.table(numeroEncontradoTwo);

let numerosImparesTwo = [];

for (let i = 1   ; i <= 50; i += 1) {
if ((i % 2) == 1){
numerosImparesTwo.push(i);
} 
}
console.table(numerosImparesTwo);

let numerosImpares = [];
let numeroEncontrado = [];

for (let i = 0; i < 155; i += 1) {
if ((numerosImparesTwo[i] % 3) == 0){
numerosImparesTwo.push(i);
} 
}
if (numerosImparesTwo.length > 50) {
